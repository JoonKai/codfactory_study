            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    final refreshToken =
                        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3RAY29kZWZhY3RvcnkuYWkiLCJzdWIiOiJmNTViMzJkMi00ZDY4LTRjMWUtYTNjYS1kYTlkN2QwZDkyZTUiLCJ0eXBlIjoicmVmcmVzaCIsImlhdCI6MTcxNzk1MzcwNSwiZXhwIjoxNzE4MDQwMTA1fQ.TgGaAO4UNHBHQ-ml05eyAmkAdpa_qybpUh_5rqZnW64';
                    final resp = await dio.post(
                      'http://$ip/auth/token',
                      options: Options(
                        headers: {
